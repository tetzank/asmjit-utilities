...
struct symbol_file{
	...
	//TODO: name
	//TODO: list of files
	//TODO:      -> list of debug entries per file
};

static void callGDB(const char *name, uint64_t addr, uint64_t size){
#ifndef NDEBUG
	...
	char *symfile = new char[symfile_size];
	char *ptr = symfile;
	// begin address
	*(uint64_t*)ptr = addr;
	ptr += sizeof(uint64_t);
...
// 	// unset it, just to avoid dangling pointers
